    ...
    >
        ...
        <div className="px-6 py-4 space-y-4">
              ...
              {directionOptions.map((opt) => (
                ...
                >
                  <input
                    ...
                    className="mt-0.5 text-asu-gold focus:ring-asu-gold"
                  />
                  <div>
          ...
          <div>
            ...
            />
            <p className="text-xs text-white/40 mt-0.5">Used as the thread filename in Obsidian</p>
          </div>
          ...
          <div>
            ...
            <div className="input-field flex flex-wrap gap-1.5 items-center min-h-[38px]">
              ...
              <input
                ...
                className="flex-1 min-w-[80px] outline-none bg-transparent text-sm border-none text-white/80"
          ...
          <div className="border border-white/10 rounded-lg p-3 space-y-2">
            <label className="flex items-center gap-2.5 cursor-pointer select-none">
              <input
                ...
                className="rounded text-asu-gold focus:ring-asu-gold border-white/20"
              />
            ...
            {saveAsTemplate && (
              <div className="space-y-1 pl-6">
                ...
                <p className="text-xs text-white/40">
                  Saves the email text to <code className="bg-white/5 px-1 rounded">EmailKB/templates/</code> — editable in Obsidian
                </p>
              </div>
            )}
          </div>
              ...
              <div className="space-y-1.5">
                <label className="flex items-center gap-2 text-sm cursor-pointer text-white/70">
                  <input
                    ...
                    className="text-asu-gold focus:ring-asu-gold"
                  />
                  {t('dialogs.newThread')}
                </label>
                <label className="flex items-center gap-2 text-sm cursor-pointer text-white/70">
        ...
        {/* Actions */}
        <div className="px-6 py-4 border-t border-white/[0.12] flex justify-end gap-3 shrink-0">
          <button onClick={onClose} className="btn-secondary" disabled={isSaving}>
            {t('dialogs.cancel')}
          </button>
          <button onClick={handleSave} className="btn-gold" disabled={isSaving || contacts.length === 0}>
