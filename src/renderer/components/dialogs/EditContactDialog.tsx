...
export default function EditContactDialog({
  ...
  return (
    <DraggableDialog
      ...
      subtitle={<span className="font-mono text-white/40">{contact?.slug}</span>}
    >
        {/* Form */}
        <div className="px-6 py-4 space-y-4">
          ...
          <div>
            <label className="section-label">
              {t('dialogs.name')} <span className="text-asu-gold">*</span>
            </label>
            <input
              type="text"
              value={name}
          ...
          <div>
            ...
            <div className="flex gap-4 flex-wrap">
              {channelOptions.map((ch) => (
                <label key={ch.value} className="flex items-center gap-1.5 text-sm text-white/70 cursor-pointer">
                  <input
                    type="checkbox"
          ...
          <div>
            <label className="section-label">
              {t('dialogs.tags')}
              <span className="font-normal text-white/40 ml-1">{t('dialogs.tagsHint')}</span>
            </label>
            <input
              type="text"
              value={tags}
        ...
        {/* Actions */}
        <div className="px-6 py-4 border-t border-white/[0.12] flex items-center gap-3 shrink-0">
          ...
          <div className="mr-auto">
            {!showDeleteConfirm ? (
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs text-red-400 font-medium">{t('dialogs.deleteAllThreads')}</span>
                <button
